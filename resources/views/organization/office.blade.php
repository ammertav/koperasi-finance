...
<body class="bg-gray-50 font-sans">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Kelola kantor pusat dan cabang koperasi
                    </p>
                </div>
                    ...
                    <table id="myTable" class="w-full text-left">
                        <thead class="bg-gray-100 text-gray-600 text-sm leading-normal">
                            <tr>
                                ...
                                <th class="p-4 font-bold">Induk & Alamat</th>
                                <th class="p-4 font-bold">Tanggal Buku</th>
                            ...
                            @foreach ($offices as $item)
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="p-4 space-y-1">
                                        ...
                                        <div class="text-xs text-gray-400">Kode {{ $item->code }} · Dibuat:
                                    ...
                                    <td class="p-4 text-xs space-y-1">
                                        <div class="flex items-center gap-2"><i class="fas fa-sitemap text-gray-400 w-4"></i>
                                            {{ $item->parent->name ?? '-' }}</div>
                                        <div class="flex items-center gap-2"><i
                                                class="fas fa-map-marker-alt text-gray-400 w-4"></i>
                                            {{ \Illuminate\Support\Str::limit($item->address, 30) }}</div>
                                    </td>
                                    <td class="p-4 font-medium">
                                        {{ $item->book_date->format('d M Y') }}
                                    </td>
    ...
    <script src="{{ asset('modal/office.js') }}"></script>

    <!-- Modals -->
    @if (auth()->user()->hasAccess('organization', 'manage'))
        @include('organization.modal.officeAdd')
        @include('organization.modal.officeEdit')
    @endif
